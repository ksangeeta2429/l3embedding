...
sleep 1
sbatch --export=filename=pruned_audio_0.51833.h5 gen_embedding_pruned_melspec2_us8k.sbatch
sleep 1
sbatch --export=filename=pruned_audio_0.571075.h5 gen_embedding_pruned_melspec2_us8k.sbatch
sleep 1
...
sleep 1
sbatch --export=filename=pruned_audio_0.4983367919921875.h5 gen_embedding_pruned_melspec2_us8k.sbatch
