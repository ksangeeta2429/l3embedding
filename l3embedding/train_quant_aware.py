...
def restore_save_quantized_model(model_path, output_dir):
 ...
 def train(train_data_dir, validation_data_dir, output_dir, num_epochs=150, 
          ...
          samp_rate=48000, fmax=None, halved_convs=False, log_path=None, disable_logging=False, 
    ...
    with train_graph.as_default():
        if continue_model_dir:
            ...
            m, inputs, outputs = MODELS[model_type](n_mels=n_mels, n_hop=n_hop, n_dft=n_dft, asr=samp_rate,
                                                    fmax=fmax, halved_convs=halved_convs, num_gpus=gpus)
        ...
        best_val_mae_cb = MultiGPUCheckpointCallback(best_valid_acc_weight_path,
                                                     m,
                                                     save_weights_only=False,\
                                                     save_best_only=True,\
                                                     verbose=1,\
