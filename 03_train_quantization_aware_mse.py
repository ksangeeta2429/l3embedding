...
import logging
import os.path
from l3embedding.train_quantization_aware_mse import train_quantized_model
...
def parse_arguments():
    ...
    parser.add_argument('-path',
                        ...
                        action='store',
                        type=str,
                        help='Path to the weight file to be quantized')
...
if __name__ == '__main__':
    train_quantized_model(**(parse_arguments()))
