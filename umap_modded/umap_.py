...
import umap_modded.distances as dist

import umap_modded.sparse as sparse

from umap_modded.utils import (
    tau_rand_int,
    deheap_sort,
    submatrix,
    ts,
...
from umap_modded.rp_tree import rptree_leaf_array, make_forest
from umap_modded.nndescent import (
    make_nn_descent,
    make_initialisations,
    make_initialized_nnd_search,
    initialise_search,
)
from umap_modded.spectral import spectral_layout
...
def simplicial_set_embedding(
    ...
    if n_epochs <= 0:
        ...
        if graph.shape[0] <= 10000:
            n_epochs = 500
        elif 10000 <= graph.shape[0] <= 1000000:
            n_epochs = 200
        else:
            n_epochs = 100

    print('Num. of epochs inferred from data size: {}'.format(n_epochs))
